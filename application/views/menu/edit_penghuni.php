...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-md-8">
            <?php foreach ($penghuni as $pi) : ?>
                <?= form_open_multipart('menu/proses_penghuni'); ?>
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="id" name="id" value="<?= $pi->id; ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama" class="form-control-label">Nama Lengkap</label>
                                    <input class="form-control" type="text" name="nama" value="<?= $pi->nama; ?>">
                                    <?= form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="no_kamar" class="form-control-label">KTP</label>
                                    <input class="form-control" type="text" id="no_kamar" name="no_kamar" value="<?= $pi->no_kamar; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="ktp" name="ktp" value="<?= $pi->ktp; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="alamat" name="alamat" value="<?= $pi->alamat; ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="tanggal_masuk" class="form-control-label">Tanggal Masuk</label>
                                    <input class="form-control" type="date" name="tanggal_masuk" value="<?= $pi->tanggal_masuk; ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="tanggal_pembayaran" class="form-control-label">Jatuh Tempo</label>
                                    <input class="form-control" type="date" name="tanggal_pembayaran" value="<?= $pi->tanggal_pembayaran; ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="pekerjaan" class="form-control-label">Pekerjaan</label>
                                    <input class="form-control" type="text" name="pekerjaan" value="<?= $pi->pekerjaan; ?>">
                                </div>
                            </div>
                        </div>
                        <hr class="horizontal dark">
