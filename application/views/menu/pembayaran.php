                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <p class="text-xs font-weight-bold mb-0">Nomor Kamar</p>
                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <p class="text-xs font-weight-bold mb-0">Jumlah Tagihan</p>
                        ...
                        <?php foreach ($menu as $sm) : ?>
                            <tr>
                                ...
                                <td class="w-30">
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        <div>
                                            <h6 class="text-sm mb-0"><?= $sm['jumlah_tagihan']; ?></h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-center">
                                        <h6 class="text-sm mb-0"><?= $sm['tanggal_pembayaran']; ?></h6>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-center">
                                        <h6 class="text-sm mb-0" style="color:brown"><?= $sm['status']; ?></h6>
                                    </div>
                                </td>
